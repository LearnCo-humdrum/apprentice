...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { bearing: @map.bearing, distance: @map.distance, lat: @map.lat, lng: @map.lng }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { bearing: @map.bearing, distance: @map.distance, lat: @map.lat, lng: @map.lng }
    assert_redirected_to map_path(assigns(:map))
  end
